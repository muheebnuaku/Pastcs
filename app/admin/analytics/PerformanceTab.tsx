...
import { TrendingUp, Users, Target, Activity, Sparkles, Coins } from 'lucide-react';
...
// Course/topic-level academic performance — split out of the former
// standalone Analytics page (see AnalyticsTabs) so it lives alongside
// Engagement (former Activity page) as a tab instead of a separate nav
// item that answered an overlapping question.
