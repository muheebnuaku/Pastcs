      ...
      <div className="bg-white rounded-3xl shadow-2xl w-full max-w-xl max-h-[90vh] overflow-y-auto dark:bg-white/[0.04]">
        <div className="flex items-start justify-between p-6 pb-4">
          <div>
            ...
            <p className="text-sm text-gray-500 mt-1 dark:text-gray-400">No document handy? Paste any text — notes, a textbook excerpt, a WhatsApp forward — and get a full AI lesson from it.</p>
          </div>
          <button onClick={onClose} className="text-gray-400 hover:text-gray-600 p-1 -m-1 dark:text-gray-500 dark:hover:text-gray-400">
            <X className="w-5 h-5" />
          </button>
        </div>
        ...
        <div className="px-6 pb-6 space-y-3">
          <textarea
            ...
            rows={10}
            className="w-full px-4 py-3 border border-gray-200 rounded-xl text-sm text-gray-800 placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent resize-none dark:bg-white/5 dark:border-white/10 dark:text-gray-200 dark:placeholder-gray-500"
          />
          <div className="flex items-center justify-between">
            <p className={`text-xs ${tooShort ? 'text-amber-500' : 'text-gray-400 dark:text-gray-500'}`}>
            ...
            <button
              ...
              className="px-5 py-2.5 bg-blue-600 hover:bg-blue-700 disabled:bg-gray-200 disabled:text-gray-400 text-white text-sm font-medium rounded-xl transition-colors dark:disabled:bg-white/15 dark:disabled:text-gray-500"
            >
              Create Lesson
            </button>
          </div>
