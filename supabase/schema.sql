...
-- Scoped to the student's CURRENT selected_level/selected_semester —
-- powers both the dashboard's "Topics to Review" card and the Exam
-- Countdown widget's "Focus on" list, neither of which should surface
-- weak topics from a semester the student has since moved on from.
