-- ================================================================
-- PASTCS - Complete Database Setup
...
-- ================================================================
-- SUBSCRIPTIONS TABLE (Freemium paywall — GHC 1 per level/semester)
-- ================================================================
...
CREATE INDEX idx_subscriptions_user_level_sem ON public.subscriptions(user_id, level, semester);
...
-- Courses (public read for authenticated users, admin write)
...
-- Questions
CREATE POLICY "questions_select_approved" ON public.questions FOR SELECT TO authenticated
...
BEGIN
  ...
  SELECT
    ...
    u.full_name,
    u.avatar_url,
    COALESCE(SUM(t.score), 0)::BIGINT,
    COUNT(t.id)::BIGINT,
    COALESCE(AVG(t.percentage), 0)::DECIMAL
  FROM public.users u
  LEFT JOIN public.tests t ON u.id = t.user_id
...
INSERT INTO public.topics (course_id, topic_name, description, order_index)
SELECT id, 'Word Processing', 'Microsoft Word fundamentals', 1 FROM public.courses WHERE course_code = 'DCIT103';
INSERT INTO public.topics (course_id, topic_name, description, order_index)
SELECT id, 'Spreadsheets', 'Microsoft Excel basics and formulas', 2 FROM public.courses WHERE course_code = 'DCIT103';
INSERT INTO public.topics (course_id, topic_name, description, order_index)
SELECT id, 'Presentations', 'Microsoft PowerPoint essentials', 3 FROM public.courses WHERE course_code = 'DCIT103';
INSERT INTO public.topics (course_id, topic_name, description, order_index)
SELECT id, 'Database Basics', 'Introduction to Microsoft Access', 4 FROM public.courses WHERE course_code = 'DCIT103';

INSERT INTO public.topics (course_id, topic_name, description, order_index)
SELECT id, 'Number Theory', 'Prime numbers and divisibility', 1 FROM public.courses WHERE course_code = 'DCIT105';
INSERT INTO public.topics (course_id, topic_name, description, order_index)
SELECT id, 'Set Theory', 'Sets, subsets, and operations', 2 FROM public.courses WHERE course_code = 'DCIT105';
INSERT INTO public.topics (course_id, topic_name, description, order_index)
SELECT id, 'Logic', 'Propositional and predicate logic', 3 FROM public.courses WHERE course_code = 'DCIT105';
INSERT INTO public.topics (course_id, topic_name, description, order_index)
SELECT id, 'Relations and Functions', 'Mathematical relations and functions', 4 FROM public.courses WHERE course_code = 'DCIT105';

INSERT INTO public.topics (course_id, topic_name, description, order_index)
SELECT id, 'Basic Economic Concepts', 'Scarcity, choice, and opportunity cost', 1 FROM public.courses WHERE course_code = 'ECON101';
INSERT INTO public.topics (course_id, topic_name, description, order_index)
SELECT id, 'Demand and Supply', 'Market equilibrium and price determination', 2 FROM public.courses WHERE course_code = 'ECON101';
INSERT INTO public.topics (course_id, topic_name, description, order_index)
SELECT id, 'Elasticity', 'Price and income elasticity', 3 FROM public.courses WHERE course_code = 'ECON101';
INSERT INTO public.topics (course_id, topic_name, description, order_index)
SELECT id, 'Market Structures', 'Perfect competition and monopoly', 4 FROM public.courses WHERE course_code = 'ECON101';

INSERT INTO public.topics (course_id, topic_name, description, order_index)
SELECT id, 'Descriptive Statistics', 'Mean, median, mode, and standard deviation', 1 FROM public.courses WHERE course_code = 'STAT111';
INSERT INTO public.topics (course_id, topic_name, description, order_index)
SELECT id, 'Probability Basics', 'Probability rules and calculations', 2 FROM public.courses WHERE course_code = 'STAT111';
INSERT INTO public.topics (course_id, topic_name, description, order_index)
SELECT id, 'Probability Distributions', 'Normal and binomial distributions', 3 FROM public.courses WHERE course_code = 'STAT111';
INSERT INTO public.topics (course_id, topic_name, description, order_index)
SELECT id, 'Sampling', 'Sampling methods and sampling distributions', 4 FROM public.courses WHERE course_code = 'STAT111';

INSERT INTO public.topics (course_id, topic_name, description, order_index)
SELECT id, 'Introduction to Logic', 'Basic logical reasoning', 1 FROM public.courses WHERE course_code = 'UGRC150';
INSERT INTO public.topics (course_id, topic_name, description, order_index)
SELECT id, 'Arguments and Fallacies', 'Identifying valid arguments and fallacies', 2 FROM public.courses WHERE course_code = 'UGRC150';
INSERT INTO public.topics (course_id, topic_name, description, order_index)
SELECT id, 'Critical Analysis', 'Evaluating sources and evidence', 3 FROM public.courses WHERE course_code = 'UGRC150';
INSERT INTO public.topics (course_id, topic_name, description, order_index)
SELECT id, 'Problem Solving', 'Systematic problem-solving approaches', 4 FROM public.courses WHERE course_code = 'UGRC150';
